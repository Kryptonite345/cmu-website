...
try {
    ...
    $enrollments_count = $courses_count = $feedback_count = $news_count = 0;
    $recent_enrollments = $recent_news = $courses = $feedback = [];
            ...
            <div class="header-right">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <h4><?php echo isset($_SESSION['full_name']) ? htmlspecialchars($_SESSION['full_name']) : 'Admin User'; ?></h4>
                        <p>Administrator</p>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    <?php if (!empty($recent_enrollments)): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($enrollment['email_address']); ?></td>
                            <td><?php echo htmlspecialchars($enrollment['program_applied']); ?></td>
                            <td><?php echo date('Y-m-d', strtotime($enrollment['submitted_at'])); ?></td>
                            <td>
                            ...
                            <td>
                                <button class="action-btn edit-btn" onclick="viewEnrollment(<?php echo $enrollment['id']; ?>)">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <form method="POST" style="display: inline;">
                                    <input type="hidden" name="enrollment_id" value="<?php echo $enrollment['id']; ?>">
                                    <input type="hidden" name="delete_enrollment" value="1">
                                    <button type="submit" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this enrollment?')">
